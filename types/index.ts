...
export interface ManualAddition { name: string; price: number; }

export interface OrderItem {
  cartId: string; id: string; name: string; category: string;
...
export interface ExtraItem { description: string; price: number; }
...
export interface KitchenTask {
  id: string; orderId: string; description: string;
  zone: "cucina" | "fritture" | "preparazione";  // preparazione = prep tasks zone
