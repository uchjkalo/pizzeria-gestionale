...
export default function OrdiniPage() {
  ...
  // ⬇️ FIX 2: Ordinamento alfabetico + custom_pizza sempre ultima
  const displayedItems = useMemo(() => {
    ...
    const customPizza = items.filter(i => i.id === "custom_pizza");
    const regular = items
      .filter(i => i.id !== "custom_pizza")
      .sort((a, b) => a.name.localeCompare(b.name, "it"));

    return [...regular, ...customPizza];
